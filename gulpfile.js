...
let config = {
    ...
    src: {
        styles: {
            ...
            style_aign: 'interface/themes/aign_*.scss',
...
// color themes aign css compilation
function styles_style_aign_compact() {
    let isSuccess = true;
    return gulp.src(config.src.styles.style_aign)
        .pipe(gap.prependText('$compact-theme: false;\n'))
        .pipe(injector.replace('// bs4import', '@import "../oemr_compact_imports";'))
        .pipe(sourcemaps.init())
        .pipe(sass().on('error', (err) => {
        ...
        .on('end', () => {
            if (isSuccess) {
                console.log(logprefix + "Finished compiling AIGn color themes");
            }
        });
}
...
// compile themes
const styles = gulp.parallel(styles_style_color, styles_style_color_compact, styles_style_uni, styles_style_uni_compact, styles_style_portal,styles_style_aign_compact, styles_style_tabs, styles_style_misc, rtl_style_color, rtl_style_color_compact, rtl_style_uni, rtl_style_uni_compact, rtl_style_portal, rtl_style_tabs, rtl_style_misc);
